export default class Matrix {
  ...
  LEFT_EDGE = 13
  */
  static whichCorner(sideSize: number, idx: number) {
  ...
  static whichEdge(sideSize: number, idx: number) {
    let square = sideSize ** 2;
  ...
  static crossNeighbours(sideSize: number, idx: number) {
  ...
  static isPossibleMove(sideSize: number, previousStep: number, newStep: number) {
